            ...
            <article>
              <div className="flex items-center mb-4 space-x-4">
                <img
                  ...
                  alt=""
                />
                <p className="items-center text-center mb-4 space-y-1 font-medium dark:text-white">
              ...
              <p className=" text-start font-light text-gray-500 dark:text-gray-400">
                ...
                waterproofing.... No problems. It is obviously not the same
                build quality as those very expensive watches. But that is like
                comparing a Citroën to a Ferrari. This watch was well under
